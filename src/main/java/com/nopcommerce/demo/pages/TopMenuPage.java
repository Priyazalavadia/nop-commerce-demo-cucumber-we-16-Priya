...
public class TopMenuPage extends Utility {
    ...
    public String verifyText3(String text) {
        ...
        log.info("Getting text from : " + clickOnApparel.toString());
        return message;
    }
